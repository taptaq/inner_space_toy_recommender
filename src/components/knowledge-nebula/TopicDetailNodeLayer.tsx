  ...
  mobile: [
    {
      ...
      hotWidth: "min(16.8rem, 68vw)",
      height: "clamp(6.6rem, 12.4vh, 7.8rem)",
      hotHeight: "clamp(6.6rem, 12.4vh, 7.8rem)",
      rotate: "-1.2deg",
      skew: "skewY(-0.8deg)",
    },
    {
      left: "38%",
      top: "34%",
      width: "min(15.4rem, 62vw)",
      hotWidth: "min(15.4rem, 62vw)",
      height: "clamp(6.3rem, 11.9vh, 7.4rem)",
      hotHeight: "clamp(6.3rem, 11.9vh, 7.4rem)",
      rotate: "1.8deg",
      skew: "skewY(0.7deg)",
    },
    {
      left: "6%",
      top: "48%",
      width: "min(16.1rem, 66vw)",
      hotWidth: "min(16.1rem, 66vw)",
      height: "clamp(6.4rem, 12vh, 7.5rem)",
      hotHeight: "clamp(6.4rem, 12vh, 7.5rem)",
      rotate: "-0.9deg",
      skew: "skewY(-0.5deg)",
    },
    {
      ...
      hotWidth: "min(15rem, 60vw)",
      height: "clamp(6.2rem, 11.7vh, 7.2rem)",
      hotHeight: "clamp(6.2rem, 11.7vh, 7.2rem)",
      rotate: "1.2deg",
      skew: "skewY(0.6deg)",
    },
    {
