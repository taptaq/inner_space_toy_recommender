 ...
 *
 * 用法:
 *   npm run debug:param-chain:romp
 *   npm run debug:param-chain:romp -- "https://detail.tmall.com/item.htm?id=其它ID"
 *
...
/** 默认：ROMP店铺页；调试参数链路时建议传入点击后得到的商品详情 URL */
const DEFAULT_URL =
  'https://rongpucryp.tmall.com/shop/view_shop.htm?appUid=RAzN8HWSmfzT5RT1SLHXyLL6kMetQtqtXNZMEEU5m23mNxu1cQs&spm=a21n57.1.hoverItem.3';
