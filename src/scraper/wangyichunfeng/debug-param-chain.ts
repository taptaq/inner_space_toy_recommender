 ...
 *
 * 用法:
 *   npm run debug:param-chain:wangyichunfeng
 *   npm run debug:param-chain:wangyichunfeng -- "https://detail.tmall.com/item.htm?id=其它ID"
 *
...
/** 默认：网易春风商品详情；调试参数链路时建议传入点击后得到的完整详情 URL */
const DEFAULT_URL =
