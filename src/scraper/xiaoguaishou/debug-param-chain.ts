 ...
 *
 * 用法:
 *   npm run debug:param-chain:xiaoguaishou
 *   npm run debug:param-chain:xiaoguaishou -- "https://detail.tmall.com/item.htm?id=其它ID"
 *
...
/** 默认：小怪兽店铺页；调试参数链路时建议传入点击后得到的商品详情 URL */
const DEFAULT_URL =
  'https://xiaoguaishou.tmall.com/shop/view_shop.htm?appUid=RAzN8HWNuv49Lh1ynGgZvWJQwrYsuoBnCj1DnZKDSJGqWWNt187&spm=a21n57.1.hoverItem.2';
