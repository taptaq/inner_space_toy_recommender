...
export const CLEANED_PATH = path.resolve(__dirname, '../../data/lbdo-official-cleaned-data.json');
const RAW_TRANSLATION_CACHE_PATH = path.resolve(__dirname, '../../data/lbdo-official-raw-description-zh-cache.json');
const BRAND_NAME = 'LBDO';
...
function inferFunctionTags(text: string): string[] {
  return uniqueStrings([
    ...
    hasAnyHint(text, ['bundle', 'series']) ? '套装' : null,
  ]);
}
